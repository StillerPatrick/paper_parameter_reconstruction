...
Deep Learning erlaubt mathematischen Modellen, welche aus mehreren Verarbeitungsschichten bestehen, die Repräsentation von Daten auf verschiedenen Abstraktionsniveaus zu lernen. Deep Learning hat den Stand der Technik in Spracherkennung, Objekterkennung und in vielen anderen Bereichen wie der Genetik stark verbessert. [...] Deep Convolutional Neuronal Networks gelang der Durchbruch in der Verarbeitung von Text, Bild und Video. (Übesetzung des Autors)

- MOTIVATION PLASMA 
	- bessere Verstanden werden
	- Überleitung zu X-Ray Scattering 
	

- XRAY SCATTERING
	- universelle Technik 
	- Fourier Betragsquadrat 
	- Phasenverlust 
