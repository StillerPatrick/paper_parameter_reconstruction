...
\end{tabular}
\caption{\label{tab:cnn} Architektur des Convolutional Neuronal Networks}
\end{table}
...
\end{tabular}
\caption{\label{tab:cnn} Architektur des Fully-Connected Neuronal Networks}
\end{table}
