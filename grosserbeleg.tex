...
Das Fourier-Faltungs-Theorem kann dazu genutzt werden, die Effekte der Startparameter zu erklären. Der erste Teil der Faltung ist der Rechteckimpuls. Die Fouriertransformation einer Rechteckimpulses der Breite $2T$ wird laut (Quelle) folgend beschrieben:
Als Fourier-Transformierte ergibt sich eine oszillierende Funktion in ?. Die ersten Nulldurchga?nge liegen bei
$\omega = \pm \pi / T$ , deren Abstand bei $\Delta \omega = 2 \pi / T$. Die Breite des urspru?nglichen Impulses war
$\Delta t = 2 T$. Damit ergibt sich eine Relation:
$\Delta \omega \sim 1 / \Delta t$. Je schmaler der Rechteckimpuls - desto breiter die Frequenzverteilung $g(\omega)$ und
umgekehrt.
...
\end{tabular}
\caption{\label{tab:relative_results} Relativer Fehler bei der Schätzung von Sigma und Feature-Size}
\end{table}
