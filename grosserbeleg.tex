...
\begin{figure}[hh]
\centering
\includegraphics[scale=0.6]{images/fraunhofer_diffraction.png} 
...
\begin{figure}[]
\centering
\includegraphics[width=0.85\textwidth]{images/fraunhofer_pitch_fsize_ratio.png} 
\caption{Auswirkung der Parameter Pitch und Feature-Size auf die Bildebene. In der Tabelle wurde der Pitch-Wert zeilenweise erhöht. In jeder Spalte wurde der Feature-Size-Wert in Relation zum Pitch-Wert geändert. 1.Spalte: $\frac{1}{8} $ Pitch, 2.Spalte: $\frac{1}{4} $ Pitch, 3.Spalte: $\frac{1}{2} $ Pitch}
\label{img:fd_pitch_fsize_ratio}
\end{figure}
...
Anhand des Diagramms in Abbildung \ref{img:experiment1} ist festzustellen, dass mit steigendem Pitch-Wert die Qualität der Pitch-Schätzung sinkt. Außerdem ist in der Darstellung ein Qualitätsabfall erkennbar, wenn die Feature-Size im Verhältnis zu Pitch sehr klein ist. 
	...
	\begin{figure}[hh!]
	\centering
	\includegraphics[width=.75\textwidth]{images/experiment2.png} 
	\caption{Qualität der Pitch-Schätzung in Abhängigkeit des Startparameters Sigma}
