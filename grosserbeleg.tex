...
Durch die Zeitintegrität des Detektors, gehen die zeitlichen Abstände der Wellen verloren (Phase). Das entstandene Detektorsignal ist äquivalent zum Betragsquadrat der Fouriertransformation Gitterstruktur $\eta $ (siehe Gleichung \eqref{eq:xrayscattering})
