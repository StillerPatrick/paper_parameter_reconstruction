...
\subsection{Auswirkung der Startparameter auf das Simulationsprodukt}
...
Der Startparamter Fsize verhält sich invers zum Parameter Pitch. Mit steigendem Fsize, kommt es zu einer Erhöhung des Intensitätsmaximums und es werden weniger Frequenzen benötigt um die Gitterstruktur zu modellieren, somit sind auch weniger Peaks in der vorhanden(Abbildung \ref{img:pitch_detector}). 
...
Der letzte Starparameter Sigma hat ansteigenden Wert ähnliche Auswirkungen auf die Detektoraufnahmen, wie Fsize. Bei steigendem 
